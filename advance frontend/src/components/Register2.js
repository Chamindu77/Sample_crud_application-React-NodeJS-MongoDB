...
export default function Register2() {
    ...
    return (
        <section className="vh-100" style={{ backgroundColor: '#FDFDFD' }}>
            <div className="container " style={{ height: '729px', borderRadius: '50px', backgroundColor: '#bceedb' }}>
                            ...
                            <div className="card-body p-md-1" >
                                <div className="row justify-content-center">
                                    ...
                                    <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2" >
                                        <img src="https://img.freepik.com/free-vector/team-checklist-concept-illustration_114360-10325.jpg" className="img-fluid" alt="Sample image" />
                                    </div>
                                </div>
                            </div>
                        </div>
